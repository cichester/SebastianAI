    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-10 max-w-md w-full">
        <div className="flex justify-center mb-6">
          <div className="w-16 h-16 bg-blue-50 text-emerald-600 rounded-xl flex items-center justify-center shadow-sm">
        ...
        <div className="flex items-center my-6">
          ...
          <p className="px-4 text-sm text-slate-500">oppure</p>
          <div className="flex-1 border-t border-slate-200"></div>
        </div>
        ...
        <div className="mt-8 border-t border-slate-200 pt-6 text-center">
            <p className="text-sm text-slate-600">Hai bisogno di <a href="#" className="text-[#006e40] font-medium hover:underline">Supporto</a>? Consulta i <a href="#" className="text-[#006e40] font-medium hover:underline">Termini di Servizio</a>.</p>
        </div>
      </div>
    </div>
  );
