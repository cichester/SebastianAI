...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView, onLogout, onOpenSettings }) => {
  return (
    <aside className="fixed inset-y-0 left-0 w-64 bg-[#1e293b] text-white flex flex-col justify-between print:hidden">
      <div>
        <div className="p-6 pb-8">
          <h1 className="text-xl font-bold tracking-tight text-white">Sebastian AI</h1>
          <p className="text-xs font-semibold text-emerald-500 uppercase tracking-widest mt-1">Docente</p>
        </div>
        ...
        <nav className="flex flex-col gap-2 px-4">
          <button
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${
              currentView === 'dashboard' ? 'bg-[#059669] text-white' : 'text-slate-300 hover:bg-slate-800'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${
              currentView === 'create' ? 'bg-[#059669] text-white' : 'text-slate-300 hover:bg-slate-800'
            }`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
          ...
          <button
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${
              currentView === 'settings' ? 'bg-[#059669] text-white' : 'text-slate-300 hover:bg-slate-800'
            }`}
          >
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
      ...
      <div className="p-4 flex flex-col gap-2">
        <button className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-slate-300 hover:bg-slate-800 transition-colors">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
        ...
        <button 
          onClick={onLogout}
          className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-slate-300 hover:bg-slate-800 transition-colors mt-auto"
        >
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
